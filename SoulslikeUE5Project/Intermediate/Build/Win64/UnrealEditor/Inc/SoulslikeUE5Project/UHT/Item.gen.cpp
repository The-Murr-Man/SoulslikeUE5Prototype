...
#include "SoulslikeUE5Project/Public/Items/Item.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeItem() {}
// Cross Module References
	ENGINE_API UClass* Z_Construct_UClass_AActor();
	ENGINE_API UClass* Z_Construct_UClass_UStaticMeshComponent_NoRegister();
	SOULSLIKEUE5PROJECT_API UClass* Z_Construct_UClass_AItem();
	SOULSLIKEUE5PROJECT_API UClass* Z_Construct_UClass_AItem_NoRegister();
...
// End Cross Module References
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AItem_TransformedSin_Statics::Function_MetaDataParams[] = {
		...
		{ "Comment", "// Function is exposed to blueprint and takes no input params\n" },
#endif
		{ "ModuleRelativePath", "Public/Items/Item.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Function is exposed to blueprint and takes no input params" },
#endif
	};
#endif
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AItem_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_AItem_TransformedSin, "TransformedSin" }, // 3515747062
	};
...
#if !UE_BUILD_SHIPPING
		{ "Comment", "// Allows variable to be edited from both details and event graph\n" },
#endif
		{ "ModuleRelativePath", "Public/Items/Item.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Allows variable to be edited from both details and event graph" },
#endif
	};
#endif
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AItem_Statics::NewProp_runningTime_MetaData[] = {
		...
		{ "Category", "Item" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "// Allows variable to be seen in details\n" },
#endif
		{ "ModuleRelativePath", "Public/Items/Item.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Allows variable to be seen in details" },
#endif
	};
#endif
	...
	template<> SOULSLIKEUE5PROJECT_API UClass* StaticClass<AItem>()
	{
		return AItem::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(AItem);
	AItem::~AItem() {}
	struct Z_CompiledInDeferFile_FID_SoulslikeUE5Project_Source_SoulslikeUE5Project_Public_Items_Item_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_SoulslikeUE5Project_Source_SoulslikeUE5Project_Public_Items_Item_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AItem, AItem::StaticClass, TEXT("AItem"), &Z_Registration_Info_UClass_AItem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AItem), 782805980U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_SoulslikeUE5Project_Source_SoulslikeUE5Project_Public_Items_Item_h_2172430485(TEXT("/Script/SoulslikeUE5Project"),
		Z_CompiledInDeferFile_FID_SoulslikeUE5Project_Source_SoulslikeUE5Project_Public_Items_Item_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_SoulslikeUE5Project_Source_SoulslikeUE5Project_Public_Items_Item_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
